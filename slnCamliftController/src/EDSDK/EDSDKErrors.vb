...
Namespace CanonCamera.Sdk
    Public Module EDSDKErrors
        ...
        Public Const EDS_ERR_TAKE_PICTURE_AF_NG As Integer = &H8D01
        Public Const EDS_ERR_TAKE_PICTURE_RESERVED As Integer = &H8D02
        Public Const EDS_ERR_TAKE_PICTURE_MIRROR_UP_NG As Integer = &H8D03
        Public Const EDS_ERR_TAKE_PICTURE_SENSOR_CLEANING_NG As Integer = &H8D04
        Public Const EDS_ERR_TAKE_PICTURE_SILENCE_NG As Integer = &H8D05
        Public Const EDS_ERR_TAKE_PICTURE_NO_CARD_NG As Integer = &H8D06
        Public Const EDS_ERR_TAKE_PICTURE_CARD_NG As Integer = &H8D07
        Public Const EDS_ERR_TAKE_PICTURE_CARD_PROTECT_NG As Integer = &H8D08
